...
$RootPath = "\\nbedsoftware\msi\ConfigMgr\Source\Drivers\SCCMTempDrivers\CustomDriverAutomation"
...
if ($SendCompletionEmail = "True")
{
	...
	$SendEmailFrom = "ASD-ITSS Driver Team Notifications <noreply@nbed.nb.ca>"
	$SendEmailTo = "(ASD) SCCM OSD-Driver Team Communications <asd.SCCMdriverteam@gnb.ca>"
